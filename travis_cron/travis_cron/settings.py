...
DATABASES = {
    'default': {
        ...
        'NAME': SITE_ROOT + 'db.sqlite',            # Or path to database file if using sqlite3.
...
SECRET_KEY = '%#yu70u!t$3*@g5sa0jid8!kqq$6p$y-b_v5(5x0w!zlfe07m%'
...
ROOT_URLCONF = 'travis_cron.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'travis_cron.wsgi.application'
